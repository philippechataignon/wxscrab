...
/* $Id: board.h 9 2004-03-17 09:47:34Z philippe $ */
...
Board  Board_copy           (Board dest, Board src);
...
int    Board_calc_cross(Dictionary d, Board b, Bag g) ;
int    Board_calc_scrab(Board b) ;
